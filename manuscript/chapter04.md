...
[//]: # (Consider reorganising this content in a way that I describe each dimension, and for each dimensions how it is generated by the two others, rather than presenting each dyads. I could structure the presentation of the dimensions as why, how and what: why capabilities, why aspirations, etc. then how are the generated and how they contribute to agency, and then finally, what they are.)

## Aspirations

*Fig. 1: Generative relationship of aspirations*
```mermaid
graph LR
  Capabilities<-->Aspirations<-->Affordances;
```
> **Axiom 1: Aspirations delineate affordances**

Affordances are not given. They do not exist objectively in the environment. Rather, their existence must be delineated by the aspirations for which they become affordances. This is true for both material and social affordances. For example, a rock can become a tool to Robinson, but only if he wants to use it for something. The same rock can provide multiple affordances, or act as multiple tools, depending of what he wants to achieve with it. Robinson’s aspiration to open up the coconut motivates his perception of the rock as a tool to do so. Likewise, a friend may provide different sets of affordances depending on what our aspirations are. The same friend might help us by sharing information, organising a trip or being a confidente. By regarding affordances as the result of aspirations, we can more clearly analyse our agency by looking closely at the affordances we delineate from our environment. We thus get a better grasp of how and where our agency lies, and how we can improve it.

> **Axiom 2: Aspirations motivate capabilities**

What motivates humans and non-humans to develop capabilities is at the core of understanding agency. 

The models entails that aspirations motivate individuals to acquire and develop capabilities.  
...
*Fig. 2: Generative relationship of affordances*
```mermaid
graph LR
  Aspirations<-->Affordances<-->Capabilities;
```
> ** Axiom 3: Axiom Affordances frame aspirations**

Looking at how affordances influence aspirations would help us understand how the environment also shapes agency. So far, we have seen how aspirations motivates us to delineate affordances from our environment. This complies with the common view that aspirations preceede affordances. This would entail that the will defines the tool. Yet, agency is not so simple and the interaction between its dimensions is reciprocal. Each dimension has a defining effect unto the two others. The effect of affordances act on aspirations plays a central role in understanding the clockwork of agency. For instance, one could compare the effect of affordances on aspirations to a kit for arts and craft. Give such a kit to a kid, and they will play endlessly with what it contains: paint, brushes, glue, glitters, scissors, paper puncher, etc. More creative kids might even come up with unforseen ways of using these items. They might even look around to see if they couldn’t find other tools to fabricate more intricate projects. If not, they could ask a parent to provide them with new ones. But in any case, most do with that they have at their disposal. If they had received other tools, they would have come up with other project ideas, with other aspirations. This examples is meant to show how most of the things we imagine for ourselves depend on what we have at our disposal, or that we know that we have at our disposal. This is true also outside of the art and craft workshop. Might it be in very hands-on jobs or very abstract thinking processes, our thinking is bound to what we know we can use: a tool, a machine, somebody’s skill, a scientific concept, etc. Thinking beyond the affordances we perceive in our environment requires a certain set of skills, which need to be honed over time. Most of the time, previous experience or examples enables us to do so. In other words, we rely on affordances to craft our aspirations. 

> **Axiom 4: Affordances fabricate capabilities**

The question of how we develop capabilities is at the core of many research fields, ranging from child development psychology to artificial intelligence. From the perpective of cognitive science, capabilities, or the capacity to do something, pertains to the embodiment of knowledge. May they be physical, like knitting, of mental, like doing calculus, capabilities constitute one of the distinct forms of intelligence. It is therefore unsurprising that contemporary approaches to AI focus almost exclusively on capabilities. In other words, what AI does is, foremost, to emulate capabilities in order to enhance or own. Coming from development economics, notably through the work of Amartya Sen, the term capability has, however, a more profound social meaning, which should not be lost. For Sen, capabilities provide not a measure of intelligence, but means for emancipation and empowerment. In this framework, capabilities are not cumulative, but contextual. Autonomy entails not the honing of a define set of capabilities over time, but the fabrication of capabilities that address individuals’ aspirations and that depend on the context of these aspirations. This relationship between the environment and the capabilities, I argue, is a matter of fabrication. We have seen so far that affordances frame aspirations by defining the basic building blocks of agency from what can be found in our social or physical environment. The same could be said about their generative effect on capabilities. Our environment is full of people and object, which we learn to identify and use over time. Their sole presence thus contributes to enhance our skills at understanding the worlds, its diversity and its complexity. When we mobilise our agency, these artefacts provide opportunities in the form of **invites**. One set of  capabilities that is central to action is the capacity to assess, navigate and level affordances in our environment. We hone such set of capacity by doing just so, and the more affordances we define affordances in the course of our lives, the better we become at quickly finding and mobilising them. In that sense, affordances fabricate capabilities, because we are in the constant process of testing how ideal, social and material artefacts can be used to actualise our aspirations.

## Capabilities

*Fig. 3: Generative relationship of affordances*
```mermaid
graph LR
  Affordances<-->Capabilities<--> Aspirations;
```

*axiom 4.*
> Capabilities reveals affordances
[//]: # (>>>>>> Describe axiome 4)
